...
func (*SupportsFeatureRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_575e2421c56be17a, []int{0}
}
...
func (*SupportsFeatureResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_575e2421c56be17a, []int{1}
}
...
func (*ReadResourceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_575e2421c56be17a, []int{2}
}
...
func (*ReadResourceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_575e2421c56be17a, []int{3}
}
...
type RegisterResourceRequest struct {
	...
	CustomTimeouts          *RegisterResourceRequest_CustomTimeouts                  `protobuf:"bytes,16,opt,name=customTimeouts" json:"customTimeouts,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}                                                 `json:"-"`
	XXX_unrecognized        []byte                                                   `json:"-"`
	XXX_sizecache           int32                                                    `json:"-"`
}
...
func (*RegisterResourceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_575e2421c56be17a, []int{4}
}
...
func (*RegisterResourceRequest_PropertyDependencies) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_575e2421c56be17a, []int{4, 0}
}
...
type RegisterResourceRequest_CustomTimeouts struct {
	Create               float32  `protobuf:"fixed32,1,opt,name=create" json:"create,omitempty"`
	Update               float32  `protobuf:"fixed32,2,opt,name=update" json:"update,omitempty"`
	Delete               float32  `protobuf:"fixed32,3,opt,name=delete" json:"delete,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*RegisterResourceRequest_CustomTimeouts) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_575e2421c56be17a, []int{4, 1}
}
...
func (m *RegisterResourceRequest_CustomTimeouts) GetCreate() float32 {
	if m != nil {
		return m.Create
	}
	return 0
...
func (m *RegisterResourceRequest_CustomTimeouts) GetUpdate() float32 {
	if m != nil {
		return m.Update
	}
	return 0
...
func (m *RegisterResourceRequest_CustomTimeouts) GetDelete() float32 {
	if m != nil {
		return m.Delete
	}
	return 0
...
func (*RegisterResourceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_575e2421c56be17a, []int{5}
}
...
func (*RegisterResourceOutputsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_575e2421c56be17a, []int{6}
}
...
func init() { proto.RegisterFile("resource.proto", fileDescriptor_resource_575e2421c56be17a) }

var fileDescriptor_resource_575e2421c56be17a = []byte{
	...
	,
}
